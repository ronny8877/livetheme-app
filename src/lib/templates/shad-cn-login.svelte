...
<div class="mx-auto grid h-screen max-w-5xl place-items-center items-center align-middle">
		...
		<Card.Root class="overflow-hidden p-0">
			<Card.Content class="grid p-0 md:grid-cols-2">
				...
				<div class="bg-muted relative hidden md:block">
					<img
						src="https://i.pinimg.com/736x/ab/02/16/ab02164480a97b4927610ddae3bece21.jpg"
						alt="placeholder"
